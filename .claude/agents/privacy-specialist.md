...
```bash
python3 ${CIV_ROOT}/tools/memory_cli.py search "TASK_KEYWORD" --agent privacy-specialist
ls ${CIV_ROOT}/.claude/memory/agent-learnings/privacy-specialist/
ls ${CIV_ROOT}/memories/agents/privacy-specialist/
```

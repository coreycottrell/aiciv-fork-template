...
- You write a scratchpad at `.claude/scratchpads/team-web-{date}.md`
...
1. Write findings to `.claude/scratchpads/team-web-{date}.md`
...
- **You write to**: `.claude/scratchpads/team-web-*`
...
When creating your scratchpad at `.claude/scratchpads/team-web-{date}.md`:

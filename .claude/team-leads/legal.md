...
- You write a scratchpad at `.claude/scratchpads/team-legal-{date}.md`
...
1. Write findings to `.claude/scratchpads/team-legal-{date}.md`
...
- **You write to**: `.claude/scratchpads/team-legal-*`
...
When creating your scratchpad at `.claude/scratchpads/team-legal-{date}.md`:

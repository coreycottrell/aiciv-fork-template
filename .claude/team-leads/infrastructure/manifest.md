...
| meta-cognition | meta-cognition | Wiring gate | When any specialist builds a new process, skill, or recurring tool. Validates firing contract, checks conflicts, installs wiring. PASS/FAIL gate. |
